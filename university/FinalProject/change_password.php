...
echo '<a href="lecturer/add.php" id="href_btn">Добави преподавател</a>';
echo '<a href="lecturer/list.php" id="href_btn">Виж преподаватели</a>';
...
<body>
	<div class="login_pass">
		...
		<form action="change_password.php" class="general" method="POST">
			<ul class="login_pass">
