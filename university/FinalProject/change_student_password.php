...
echo '<a href="student/list_logged.php" id="href_btn">Виж дисциплини</a>';
echo '<a href="change_student_password.php" id="href_btn">Промени паролата</a>';
echo '</div>';
...
if($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if(empty($new_pass_check) && empty($old_pass_check)) {
		...
		$update_user->execute();
		header("Location: student/list_logged.php");
	}
}
?>
<!DOCTYPE html>
...
<body>
	<div class="login_pass">
		...
		<form action="change_student_password.php" class="general" method="POST">
			<ul class="login_pass">
